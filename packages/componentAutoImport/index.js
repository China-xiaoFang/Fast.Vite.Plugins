 ...
 * @param dir 组件文件夹路径
 */
function tsxComponentAutoImport(options) {
    if (!options)
        return;
    return {
...
`;
            ...
            fs.writeFileSync(path.join(dir, "index.ts"), `import type { Plugin } from "vue";
${importContent}
${exportContent}
export default [
${typeContent}
 ...
 * @param dir 组件文件夹路径
 */
function vueComponentAutoImport(options) {
    if (!options)
        return;
    return {
...
`;
            ...
            fs.writeFileSync(path.join(dir, "index.ts"), `import type { DefineComponent } from "vue";
${importContent}
${exportContent}
export default [
${typeContent}
