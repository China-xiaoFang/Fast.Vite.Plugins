"use strict";var E=Object.create;var x=Object.defineProperty;var k=Object.getOwnPropertyDescriptor;var U=Object.getOwnPropertyNames;var M=Object.getPrototypeOf,O=Object.prototype.hasOwnProperty;var b=(t,e)=>{for(var n in e)x(t,n,{get:e[n],enumerable:!0})},F=(t,e,n,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let o of U(e))!O.call(t,o)&&o!==n&&x(t,o,{get:()=>e[o],enumerable:!(s=k(e,o))||s.enumerable});return t};var g=(t,e,n)=>(n=t!=null?E(M(t)):{},F(e||!t||!t.__esModule?x(n,"default",{value:t,enumerable:!0}):n,t)),R=t=>F(x({},"__esModule",{value:!0}),t);var Z={};b(Z,{buildSvgIcon:()=>J,cdnImport:()=>H,findSvgFile:()=>C,tsxComponentAutoImport:()=>W,versionUpdatePlugin:()=>Y,vueComponentAutoImport:()=>_,writeTSXIcon:()=>T});module.exports=R(Z);var f=g(require("fs"),1),l=g(require("path"),1),C=t=>{let e=[];return f.default.readdirSync(t,{withFileTypes:!0}).forEach(s=>{if(s.isDirectory())e.push(...C(l.default.join(t,s.name)));else{let o=s.name.replace(".svg",""),c=f.default.readFileSync(l.default.join(t,s.name),"utf-8").replace(/<\?xml.*?\?>/,"").replace(/<!DOCTYPE svg.*?>/,"").trimStart().trimEnd().replace(/<svg([^>+].*?)>/,(a,p)=>{let r=p.match(/viewBox="[^"]+"/),i=p.match(/width="(\d+)"/),m=p.match(/height="(\d+)"/),u=1024,h=1024;i&&(u=i[0]),m&&(h=m[0]);let $="";return r?$=r[0]:$=`viewBox="0 0 ${u} ${h}"`,`<svg xmlns="http://www.w3.org/2000/svg" ${$}>`});e.push({iconName:o,componentName:o.charAt(0).toUpperCase()+o.slice(1),iconContent:c})}}),e.sort((s,o)=>s.iconName<o.iconName?-1:s.iconName>o.iconName?1:0)},T=(t,e,n,s)=>{let o=l.default.join(n,"src");f.default.mkdirSync(n,{recursive:!0}),f.default.mkdirSync(o,{recursive:!0});let c=`import { defineComponent } from "vue";
...
export default ${e};
`;f.default.writeFileSync(l.default.join(n,"index.d.ts"),p)};function J(t,e){if(!t||!e)return;let n;return{name:"fast-vite-plugin-build-svg-icon",configResolved:s=>{n=s},buildStart(){let s=C(l.default.resolve(n.root,t)),o=l.default.resolve(n.root,e);f.default.mkdirSync(o,{recursive:!0});let c="",a="",p="";s.forEach((r,i)=>{T(r.iconName,r.componentName,l.default.join(o,r.iconName),r.iconContent),c+=`import { ${r.componentName} } from "./${r.iconName}";
